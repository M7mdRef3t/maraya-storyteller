...
export const UI_COPY = {
  ...
  ar: {
    title: 'مرايا',
    subtitle: 'ماذا تحمل اليوم؟',
    uploadSpace: 'أو... أرني مكانك',
    modeLabel: 'نمط السرد',
    ...
    back: 'العودة',
    uploadTitle: 'أرني مكانك',
    uploadDesc: 'ارفع صورة لغرفتك أو مساحتك الحالية وسأقرأ مزاج المكان.',
    uploadDrop: 'اسحب صورة هنا أو اضغط للاختيار',
    analyzingSpace: 'المرايا تقرأ مكانك...',
    loadingStory: 'المرايا تتشكل...',
    loadingNext: 'المشهد التالي يتشكل...',
    loadingError: 'فشل في متابعة القصة.',
    restart: 'رحلة جديدة',
